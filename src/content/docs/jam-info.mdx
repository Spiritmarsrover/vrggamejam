...
Gamedev is hard! We've made a new framework you can use to make prefab games: the [Mini Udon Game Interface (Mugi)](/mugi). You're not required to use it, but it'll help a lot.
...
See [Jam Rules](/rules) for full requirements and guidelines.
