...
You're allowed to make multiple submissions that meet the requirements, up to a reasonable limit.
...
:::note
The [Mugi framework](/mugi) supports these guidelines nicely with a multiplayer lobby system, scoring, and time limit.
:::
...
TODO we'll also have some way you can try out test builds of the Exhibition yourself, details TBD
