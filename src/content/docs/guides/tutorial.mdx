...
2. Your capsule should be visible in the scene
3. Join the game using the lobby UI.
4. Start the game using the lobby UI.
5. Click the capsule to increment your score
6. Once the game ends, see your final score on the scoreboard.
</Steps>
