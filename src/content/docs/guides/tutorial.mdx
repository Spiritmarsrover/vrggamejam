...
If try to create the script directly in your package's Runtime directory, it'll break later with an error like:
...
This is some sort of bug in UdonSharp. Creating scripts in `/Assets` first seems to work around it.
